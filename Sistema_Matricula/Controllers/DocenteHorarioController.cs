...
namespace Sistema_Matricula.Controllers
{
    public class DocenteHorarioController : Controller
    {
        ...
        public DocenteHorarioController(DbMatNotaHorarioContext _db)
        {
            db = _db;
        }

        public IActionResult ListarDocenteHorario()
        {
            var docenteHorarios = db.DocenteHorarios.ToList();
            return View(docenteHorarios);
        }

        [HttpGet]
        public ActionResult AgregarDocenteHorario()
        {
